      ...
      <div className="container  xl:mx-[9rem] sm:mx-[0]">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-3/4 p-3">
            <div className="h-12 font-bold text-2xl">Update / Delete Product</div>
            ...
            {image && (
              <div className="text-center">
                <img
                  src={image}
                  alt="product"
                  className="block mx-auto w-[12rem] h-[40%] rounded-2xl"
                />
              </div>
            )}
            ...
            <div className="p-3">
              ...
              <div className="">
                ...
                <button
                  ...
                  className="py-4 px-10 mt-5 rounded-lg text-lg font-bold  bg-pink-600 cursor-pointer"
                >
                  Delete
                </button>
              </div>
